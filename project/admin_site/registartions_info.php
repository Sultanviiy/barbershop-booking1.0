...
::-webkit-scrollbar-thumb {
    -webkit-box-shadow: inset 0 0 6px rgba(0,0,0,0.9); 
		...
		<body>
			<section>
  <h1>RESERVATIONS INFORMATION TABLE</h1>
  ...
  <div class="tbl-content">
	...
	$query="SELECT * FROM bookings INNER JOIN accounts on accounts.UserID=bookings.userID";
	...
	$result=mysqli_fetch_all($data, MYSQLI_ASSOC);
		...
		foreach ($result as $re):		
			echo "
				...
				<td>".$re["timeslots"]."</td>
				<td>".$re["services"]."</td>
				<td> <a href=' REdelete.php?bookId=$re[bookId]'>Delete </td>
				</tr>
			";
		endforeach;
	?>
	...
	<a class="download" href="admin_page.php"></a>
			<script>
